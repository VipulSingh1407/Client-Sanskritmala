    ...
    <Layout>
      <div className="flex flex-col lg:flex-row  min-h-screen p-6 py-20">
        ...
        <div className="lg:w-2/3 lg:pr-6 mb-6 lg:mb-0">
          <h1 className="text-3xl font-semibold mb-4 text-gray-200">All Courses</h1>
        ...
        <div className="lg:w-1/3">
          <div className="bg-gray-700 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold mb-4 text-gray-300">Add Course</h2>
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-4">
                <label htmlFor="createdBy" className="block text-gray-300">Created By</label>
                <input
                  type="text"
                  id="createdBy"
                  value={createdBy}
